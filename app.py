...
# Load the dataset
df = pd.read_csv(r"C:\Users\sonal\Downloads\diabetes_prediction-master\diabetes_prediction-master\diabetes.csv")

# Convert all column names to lowercase and standardize names
...
# HEADINGS
st.title('HealthLens: Diabetes Prediction and Visualisation')
...
# Match user data feature names to training data
